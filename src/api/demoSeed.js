...
export const DEMO_TASKS = [
  // ── OVERDUE (due before 2026-03-28) ──────────────────────────────────────────
  {
    id: 'demo-task-1',
    title: 'Follow up call — pre-approval status',
    dueDate: '2026-03-24',
    priority: 'High',
    linkedLeadId: 2,
    notes: 'Maria Garcia — NV — $435k Purchase. She replied to intro text but hasn\'t confirmed appointment. Call directly, discuss pre-approval timeline.',
    completed: false,
    createdAt: '2026-03-23T08:00:00Z',
  },
  {
    id: 'demo-task-2',
    title: 'Send credit authorization email',
    dueDate: '2026-03-25',
    priority: 'High',
    linkedLeadId: 3,
    notes: 'James Wilson — AZ — VA Loan $395k. COE received. Need signed credit auth before running tri-merge. Send DocuSign link.',
    completed: false,
    createdAt: '2026-03-23T09:00:00Z',
  },
  {
    id: 'demo-task-3',
    title: 'Review loan scenario',
    dueDate: '2026-03-26',
    priority: 'Medium',
    linkedLeadId: 6,
    notes: 'Jennifer Lee — CA — $685k Purchase. Run updated loan scenario with current rates. She wants 20% down conventional, confirm pricing.',
    completed: false,
    createdAt: '2026-03-24T09:30:00Z',
  },
  {
    id: 'demo-task-4',
    title: 'Check in — rate lock expiring',
    dueDate: '2026-03-27',
    priority: 'High',
    linkedLeadId: 12,
    notes: 'Patricia Gonzalez — NV — $520k In Progress. Rate lock expires 4/5. Confirm underwriting timeline. May need to extend lock.',
    completed: false,
    createdAt: '2026-03-25T08:00:00Z',
  },
  // ── DUE TODAY (2026-03-28) ────────────────────────────────────────────────────
  {
    id: 'demo-task-5',
    ...
    priority: 'High',
    linkedLeadId: 22,
    notes: 'Christopher Lee — NV — $465k Qualified. Pre-approval issued. He is touring Summerlin this weekend — schedule consultation call before he goes.',
    completed: false,
  ...
  },
  {
    ...
    priority: 'Medium',
    linkedLeadId: 8,
    notes: 'Michael Torres — NV — $515k Active. Call completed 3/15. 10% down conventional. Initial disclosures required within 3 business days of application.',
    completed: false,
  ...
  },
  {
    ...
    priority: 'Medium',
    linkedLeadId: 7,
    notes: 'Lisa Thompson — AZ — $310k Active. FHA 3.5% down candidate. Pre-approval pending income docs — 2 recent pay stubs and W-2s needed.',
    completed: false,
    createdAt: '2026-03-26T10:00:00Z',
  },
  {
    id: 'demo-task-8',
    title: 'Call re: property inspection',
    dueDate: '2026-03-28',
    priority: 'Medium',
    linkedLeadId: 10,
    notes: 'Amanda Foster — NV — $395k New. Hot new lead from Bankrate. Submitted yesterday. First outreach call — introduce pre-approval process.',
    completed: false,
    createdAt: '2026-03-27T10:00:00Z',
  },
  // ── UPCOMING (2026-03-29 through 2026-04-07) ──────────────────────────────────
  {
    id: 'demo-task-9',
    title: 'Follow up — no response 3 days',
    dueDate: '2026-03-29',
    priority: 'Low',
    linkedLeadId: 9,
    notes: 'Carlos Martinez — NV — $445k Cold. Third follow-up attempt. Send personal check-in email — mention FHA options for his credit range.',
    completed: false,
    createdAt: '2026-03-27T11:00:00Z',
  },
  {
    id: 'demo-task-10',
    title: 'VA certificate verification',
    dueDate: '2026-03-30',
    priority: 'Medium',
    linkedLeadId: 3,
    notes: 'James Wilson — AZ — VA Loan. COE needs final verification with VA system. Confirm entitlement amount before issuing final pre-approval letter.',
    completed: false,
  ...
  },
  {
    ...
    priority: 'Low',
    linkedLeadId: 11,
    notes: 'Kevin Nguyen — CA — $420k Refi Qualified. Rate locked at 6.375%. Keep warm while appraisal processes. Monthly touch-base.',
    completed: false,
    createdAt: '2026-03-28T10:00:00Z',
  },
  {
    id: 'demo-task-12',
    title: 'Send rate update email',
    dueDate: '2026-04-02',
    priority: 'Medium',
    linkedLeadId: 15,
    notes: 'Samantha Davis — NV — $375k Active. She mentioned comparison shopping. Send updated rate comparison showing our competitive pricing.',
    completed: false,
    createdAt: '2026-03-28T10:30:00Z',
  },
  {
    id: 'demo-task-13',
    title: 'Review new purchase offer',
    dueDate: '2026-04-04',
    priority: 'High',
    linkedLeadId: 13,
    notes: 'Emily Chen — AZ — $285k New. Fresh lead submitted today. FHA 3.5% down. First-time buyer — schedule intro call and review loan options.',
    completed: false,
  ...
  },
  {
    ...
    priority: 'Low',
    linkedLeadId: 4,
    notes: 'Sarah Johnson — NV — Closed Won. Loan funded 3/14. 30-day post-close follow-up call. Ask for referrals — she mentioned two coworkers.',
    completed: false,
  ...
  },
  {
    ...
    priority: 'Medium',
    linkedLeadId: 25,
    notes: 'Michelle Kim — FL — $425k In Progress. Appraisal complete at $432k. File in underwriting. Review all docs before closing call. Closing set 4/8.',
    completed: false,
