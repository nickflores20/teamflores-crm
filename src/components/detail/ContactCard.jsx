      ...
      <div className="px-5 py-4 border-b border-surface-border -mt-4 bg-white rounded-t-xl relative z-10">
        ...
        <div className="flex gap-2">
          {lead['Phone'] && (
            <a
              href={`tel:${lead['Phone']}`}
              className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-green-50 text-green-700 border border-green-200 text-sm font-semibold hover:bg-green-100 transition-colors"
            >
          ...
          {lead['Email'] && (
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-blue-50 text-blue-700 border border-blue-200 text-sm font-semibold hover:bg-blue-100 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
